CREATE TABLE `app` (
  ...
  `name` varchar(20) NOT NULL COMMENT '秘钥',
  `token_expired_time` int(11) NOT NULL DEFAULT '0' COMMENT 'token过期时间',
  `refresh_token_expired_time` int(11) NOT NULL DEFAULT '0' COMMENT '刷新token过期时间',
