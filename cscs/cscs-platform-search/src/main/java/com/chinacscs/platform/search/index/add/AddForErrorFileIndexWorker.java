 ...
 * @describe: //TODO
 */
public class AddForErrorFileIndexWorker extends FileIndexWorker {

	protected final static Logger log = LoggerFactory.getLogger(AddForErrorFileIndexWorker.class);

	public AddForErrorFileIndexWorker() {
