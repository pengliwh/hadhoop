 ...
 * @describe: //TODO
 */
public class AddForNewFileIndexWorker extends FileIndexWorker {

	protected final static Logger log = LoggerFactory.getLogger(AddForNewFileIndexWorker.class);

	public AddForNewFileIndexWorker() {
