 ...
 * @describe: //TODO
 */
public class AddForFinishFileIndexWorker extends FileIndexWorker {

	protected final static Logger log = LoggerFactory.getLogger(AddForFinishFileIndexWorker.class);

	public AddForFinishFileIndexWorker() {
